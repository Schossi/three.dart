...
class RSObjLoader extends Loader {
  ...
  _create_face(a, b, c, vertices, [normals, normals_inds = null]) {
    ...
    face.materialIndex=currentIndex==null? 0:currentIndex;
    ...
    lines.forEach((line) {
      ...
      if (!(line.length == 0 || line.startsWith('#'))) {
        if ((result = vertex_pattern.firstMatch(line)) != null) {
          ...
          String matName=line.replaceAll("usemtl ", "");
          
          if(matIndexes!=null && matIndexes.containsKey(matName))
            currentIndex=matIndexes[matName];
